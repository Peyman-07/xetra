...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def test_update_meta_file_no_meta_file(self):
        ...
        """
        # Expected results
        date_list_exp = ['2024-01-02', '2024-01-03']
        ...
        proc_date_list_result = list(
            pd.to_datetime(df_meta_result[MetaProcessFormat.META_PROCESS_DATE_COL.value])\
            .dt.date
            )
    ...
    def test_update_meta_file_meta_file_ok(self):
        ...
        """
        # Expected results
        date_list_old = ['2024-01-02', '2024-01-03']
        date_list_new = ['2024-03-10', '2024-03-11']
        ...
        meta_content = (
          ...
          f'{MetaProcessFormat.META_PROCESS_DATE_COL.value}\n'
          f'{date_list_old[0]},'
    ...
    def test_update_meta_file_meta_file_wrong(self):
        ...
        meta_key = 'meta.csv'
        meta_content = (
          f'wrong_column,{MetaProcessFormat.META_PROCESS_DATE_COL.value}\n'
          f'{date_list_old[0]},'
          f'{datetime.today().strftime(MetaProcessFormat.META_PROCESS_DATE_FORMAT.value)}\n'
          f'{date_list_old[1]},'
          f'{datetime.today().strftime(MetaProcessFormat.META_PROCESS_DATE_FORMAT.value)}'
    ...
    def test_return_date_list_no_meta_file(self):
        ...
        date_list_exp = [
            datetime.strftime(start+timedelta(days=x), MetaProcessFormat.META_DATE_FORMAT.value) \
    ...
    #     # Expected results
    #     min_date_exp = [
    #       (datetime('2022-02-16').date() + timedelta(days=1))\
    #           .strftime(MetaProcessFormat.META_DATE_FORMAT.value),
    #       (datetime('2022-02-16').date() + timedelta(days=2))\
    #           .strftime(MetaProcessFormat.META_DATE_FORMAT.value),
    #       (datetime('2022-02-16').date() + timedelta(days=7))\
    #           .strftime(MetaProcessFormat.META_DATE_FORMAT.value)
    #     ]
    #     date_list_exp = [
